...
public class TourController {
    ...
    @Autowired
    public TourController(TagService tagService, CityService cityService, TourCategoryService tourCategoryService, TourService tourService, StopService stopService) {
    ...
    public String showCreateTourForm(Model model, SessionStatus sessionStatus) {
        ...
        // Fetch and add objects to the model
//        List<Tag> tags = tagService.getAllTags();
//        model.addAttribute("tags", tags);
//
//        List<TourCategory> tourCategories = tourCategoryService.getAllTourCategories();
