 ...
 */
public class DBTests extends AbstractTest{
    ...
    public void testDbConnectionProperties () throws IOException {
        ...
        Pattern urlPattern = Pattern.compile("spring.datasource.url=jdbc:mysql://localhost:3306/getcultured");
        ...
        Pattern usernamePattern = Pattern.compile("spring.datasource.username=getcultured");
        ...
        Pattern passwordPattern = Pattern.compile("spring.datasource.password=getcultured");
